...
describe("Calculation of triangle parameters", () => {
	const geom = new Geometric({ x: 10, y: 10, rotate: Math.PI });
	const triangle = geom.createTringle();

	test("Checking the calculation on two sides and angle", () => {
	...
	test("Checking the calculation by side and two angles", () => {
	...
	test("Checking the calculation on three sides", () => {
